# AGENTS.md — InfoLCD - Apex Advanced
...
InfoLCD variant for Apex LCD blocks (Advanced feature set — sibling to Apex Update).
...
**Board:** [InfoLCD Apex Advanced board](https://github.com/orgs/gitpush-mod/projects/4)
